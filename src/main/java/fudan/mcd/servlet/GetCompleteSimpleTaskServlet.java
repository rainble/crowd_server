...
@WebServlet("/GetCompleteSimpleTaskServlet")
public class GetCompleteSimpleTaskServlet extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        List<SimpleTaskVO> rvoList = service.queryCompleteSimpleTaskListByUser(userId);
